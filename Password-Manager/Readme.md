A very small password management app for storing individual account names and passwords locally using [node-persist](https://github.com/simonlast/node-persist). 
